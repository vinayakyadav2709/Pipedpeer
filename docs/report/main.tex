...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\textwidth]{\figpath{fig_3.1_system_design.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{\figpath{fig_3.2_dfd_level0.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.86\textwidth]{\figpath{fig_3.3_dfd_level1.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.88\textwidth]{\figpath{fig_3.4_use_case.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath{fig_3.5_sequence.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.80\textwidth]{\figpath{fig_4.1_placement_flow.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath{fig_4.2_scoring_weights.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.90\textwidth]{\figpath{fig_4.3_lease_fsm.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.62\textwidth]{\figpath{fig_4.4_closure_cache.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.60\textwidth]{\figpath{fig_4.8_hash_shuffle.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.86\textwidth]{\figpath{fig_4.10_ddp.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath{fig_4.7_race_timeline.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath{fig_5.1_closure_cache.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath{fig_5.2_shim_overhead.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.90\textwidth]{\figpath{fig_5.3_sandbox_overhead.png}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{\figpath{fig_5.4_comparison.png}}
    \caption{The same comparison in matrix form.}
    \label{fig:rescomp}
\end{figure}

The comparison should be read carefully. Spark, Ray and Dask are more capable at
scale, with mature schedulers, sophisticated fault tolerance and years of
production use behind them; the axis on which PipedPeer differs is setup cost and
code change, not raw capability. BOINC is closest in spirit, having pioneered
